...
var t_search []Search
var t_languages = []string{"JavaScript","Python","Java","Go","Ruby","PHP","Shell","CSV","Markdown","XML","JSON","Text","CSS","HTML","Perl","ActionScript","Lua","C","C%2B%2B","C%23","CoffeeScript","Dart","DM","Elixir","Kotlin","Objective-C","Perl","PowerShell","Rust","Scala","Swift","TypeScript"}
